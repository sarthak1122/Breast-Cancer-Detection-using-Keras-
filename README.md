...
TensorFlw is cross-platform. It runs on nearly everythng: GPUs and CPUs—including mobile and embedded platfrms—and even tensor processing units (TPUs), which are specialized hardware to do tensor math on.
